...
class BaseRedis:
	...
	# =============== EVENT LIST ========================
	def get_length_list(self, key: str) -> int:
		return self._db.llen(key)

	def get_index_list(self, key: str, idx: int) -> list:
		try:
			idx = int(idx)
		except:
